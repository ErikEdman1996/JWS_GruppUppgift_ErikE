    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/wigelltravels/v1/booking/**").hasRole("ADMIN")
                        .requestMatchers("/api/wigelltravels/v1/updatebooking").hasRole("ADMIN")
                        .requestMatchers("/api/wigelltravels/v1/deletebooking").hasRole("ADMIN")
                        .requestMatchers("/api/wigelltravels/v1/destination/**").hasRole("ADMIN")
                        .requestMatchers("/api/wigelltravels/v1/add_destination").hasRole("ADMIN")
                        .requestMatchers("/api/wigelltravels/v1/updatedestination").hasRole("ADMIN")
                        .requestMatchers("/api/wigelltravels/v1/deletedestination/**").hasRole("ADMIN")
                        .requestMatchers("/api/wigelltravels/v1/listdestinations").hasRole("ADMIN")
